...
#####################################################################################################################
def sigmoid(n):
    return 1 / (1 + np.exp(-n)) # activation function for the neurons
...
def tanh(n):
    ...
    # activation function for the neurons from sigmoid to hyperbolic tangent
#####################################################################################################################
#####################################################################################################################
...
def tanhDerivative(n):
    return (1 + n) * (1 - n) #the derivate for hyperbolic tangent
#####################################################################################################################
#####################################################################################################################
...
def main():
    ...
    labels = np.array([[-1], [1], [1], [-1]]) # Using -1 for the "low" state is standard for tanh networks.
